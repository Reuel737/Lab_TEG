...
modelo_path = f"{regiao}/results/{experimento}/{experimento}_erros.keras"
...
pasta_saida = f"{regiao}/graficos/hist_cumulativo"
os.makedirs(pasta_saida, exist_ok=True)
caminho_imagem = os.path.join(pasta_saida, f"hist_cumulativo_{nome_experimento}.png")
